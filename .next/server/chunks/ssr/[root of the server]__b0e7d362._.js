...
let auth;
let db;
let analytics; // analytics can be undefined if not on client
    ...
    if (!userSnapshot.exists()) {
        ...
        try {
            ...
            if (freshSnapshot.exists()) {
                ...
                const finalCreatedAt = data.createdAt && typeof data.createdAt.toDate === 'function' ? data.createdAt.toDate() : new Date();
                return {
                    ...data,
                    uid,
            ...
            if (user) {
                ...
                if (!userProfile) {
                    userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createUserDocumentFromAuth"])(user, {
                        ...
                        signupMethod: user.providerData.some((p)=>p.providerId === 'google.com') ? 'google' : user.providerData.some((p)=>p.providerId === 'phone') ? 'phone' : 'email'
                    });
                } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b0e7d362._.js.map