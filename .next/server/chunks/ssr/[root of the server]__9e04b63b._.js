...
const createUserDocumentFromAuth = async (userAuth, additionalInformation = {})=>{
    ...
    if (!userSnapshot.exists()) {
        ...
        const createdAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serverTimestamp"])(); // Use Firestore server timestamp
...
function AuthProvider({ children }) {
        ...
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChangedListener"])(async (user)=>{
            if (user) {
                ...
                if (!userProfile) {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createUserDocumentFromAuth"])(user); // Create if doesn't exist from Google sign in
                    userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserProfile"])(user.uid); // Fetch again
                    if (userProfile) {
    ...
    if (loading && "undefined" !== 'undefined' && !currentUser) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9e04b63b._.js.map