(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_201a4816._.js", {
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    // For this setup, we assume auth and db will primarily be used client-side
    // If server-side Firebase Admin SDK is used elsewhere, this client setup is separate
    app = {}; // Placeholder
    auth = {}; // Placeholder
    db = {}; // Placeholder
}
...
const createUserDocumentFromAuth = async (userAuth, additionalInformation = {})=>{
    ...
    if (!userSnapshot.exists()) {
        ...
        const createdAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])(); // Use Firestore server timestamp
...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChangedListener"])({
                "AuthProvider.useEffect.unsubscribe": async (user)=>{
                    if (user) {
                        let userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(user.uid);
                        if (!userProfile) {
                            ...
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserDocumentFromAuth"])(user); // Create if doesn't exist from Google sign in
                            userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(user.uid); // Fetch again
                            if (userProfile) {
    ...
    if (loading && "object" !== 'undefined' && !currentUser) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase/auth.ts [app-client] (ecmascript)"); // Import signOutUser
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/avatar.tsx [app-client] (ecmascript)"); // Import Avatar components
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/dropdown-menu.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function Header() {
    ...
    const { currentUser, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // Use AuthContext
    const [walletBalance, setWalletBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0.00"); // Placeholder
...
//# sourceMappingURL=src_201a4816._.js.map