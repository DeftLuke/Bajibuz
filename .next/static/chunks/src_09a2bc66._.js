...
const createUserDocumentFromAuth = async (userAuth, additionalInformation = {})=>{
    ...
    if (!userSnapshot.exists()) {
        ...
        const firestoreCreatedAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])(); // Use serverTimestamp for new docs
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userDocRef, newUserProfileData);
            if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (freshSnapshot.exists()) {
                ...
                const finalCreatedAt = data.createdAt instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"] ? data.createdAt.toDate() : new Date(); // Fallback, should be a Timestamp
                return {
                    ...data,
                    uid,
...
const getUserProfile = async (uid)=>{
    ...
    if (userSnapshot.exists()) {
        ...
        const createdAt = data.createdAt instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"] ? data.createdAt.toDate() : data.createdAt instanceof Date ? data.createdAt : new Date(); // Fallback
        return {
            ...data,
            uid,
            createdAt
                ...
                "AuthProvider.useEffect.unsubscribe": async (user)=>{
                    if (user) {
                        ...
                        if (!userProfile) {
                            ...
                            userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserDocumentFromAuth"])(user, {
...
//# sourceMappingURL=src_09a2bc66._.js.map